...
class Model(base.Model):
    ...
    def is_valid_model_name(model_name):
        return (model_name.startswith('cifar10_simplecnn') and
    ...
    def get_model_from_name(model_name, initializer, outputs=None):
        """The name of a model is cifar10_simplecnn_N1[_N2...].
        ...
        100 feature in the second conv layer, and 10 output neurons is 'cifar10_simplecnn_300_100'.
        """
