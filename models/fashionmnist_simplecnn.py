...
class Model(base.Model):
    ...
    def is_valid_model_name(model_name):
        return (model_name.startswith('fashionmnist_simplecnn') and
    ...
    def get_model_from_name(model_name, initializer, outputs=None):
        """The name of a model is fashionmnist_simplecnn_N1[_N2...].
        ...
        100 feature in the second conv layer, and 10 output neurons is 'fashionmnist_simplecnn_300_100'.
        """
    ...
    def default_hparams():
        model_hparams = hparams.ModelHparams(
            model_name='fashionmnist_simplecnn_16_32',
