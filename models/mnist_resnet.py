...
class Model(base.Model):
    """A residual neural network as originally designed for MNIST."""
    ...
    def is_valid_model_name(model_name):
        return (model_name.startswith('mnist_resnet_') and
    ...
    def get_model_from_name(model_name, initializer,  outputs=10):
        """The naming scheme for a ResNet is 'mnist_resnet_N[_W]'.
        ...
        The name of a ResNet is 'mnist_resnet_N[_W]', where W is as described above.
        ...
        The name of the network would be 'mnist_resnet_20' or 'mnist_resnet_20_16'.
        """
