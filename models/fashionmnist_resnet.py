...
class Model(base.Model):
    """A residual neural network as originally designed for fashionMNIST."""
    ...
    def __init__(self, plan, initializer, outputs=None):
        ...
        self.conv = nn.Conv2d(1, current_filters, kernel_size=3, stride=1, padding=1, bias=False)
    ...
    def is_valid_model_name(model_name):
        return (model_name.startswith('fashionmnist_resnet_') and
    ...
    def get_model_from_name(model_name, initializer,  outputs=10):
        """The naming scheme for a ResNet is 'fashionmnist_resnet_N[_W]'.
        ...
        The name of a ResNet is 'fashionmnist_resnet_N[_W]', where W is as described above.
        ...
        The name of the network would be 'fashionmnist_resnet_20' or 'fashionmnist_resnet_20_16'.
        """
